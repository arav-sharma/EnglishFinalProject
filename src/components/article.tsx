...
const ArticleBody: React.FC = () => {
  return (
    <div className="m-auto text-justify w-8/12 prose-md prose prose-stone dark:prose-invert sm:prose-lg"> 
        ...
        <p className="text-md text-right m-auto w-10/12 text-stone-300 dark:text-stone-300 md:text-lg -mt-16 mb-5">
          <b>Author:</b> Shubham Sharan <br/> <b>Source:</b> <a className="texxt-stone-300 dark:text-stone-300"href="https://unsplash.com/photos/student-sitting-on-chairs-in-front-of-chalkboard-Z-fq3wBVfMU"><u>Unsplash ↗</u></a>
        </p>      


        <h2 className="font-titlet text-2xl text-stone-100 dark:text-white text-center mt-10 mb-4">How Educators Implement AI in Classrooms Today</h2>
